                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Comando G8 é o novo filiado da ANSEGTV</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i>  AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>07/10/2020 - 18h</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 content-news">
                            <p class="article">A ANSEGTV (Associação Nacional de Segurança e Transporte de Valores) tem um novo associado. É o Comando G8, com matriz em São Paulo e filiais em Campinas, Santos, Rio de Janeiro, Minas Gerais e Espírito Santo. O grupo atende clientes em todo o Brasil, com grande eficiência, através de profissionais treinados e equipamentos de última geração e localização estratégica.</p>
                            <figure class="pull-right m-2 text-left">
                                <img src="../../img/uploads/2020/10/logo_grupo_g8-540.png" width="450" height="auto" alt="Logo Comando G8" class=" img-fluid">	
                                <figcaption></figcaption>
                            </figure>
                            <p class="article">Criado por Anderson Albuquerque em 2.004, o Comando G8 oferece serviços de Escolta Armada, Segurança Patrimonial, Transporte de Valores, Facilities, Consultoria em Segurança e Prevenção de Perdas e Parqueamento.</p>
                            <p class="article">No total, são mais de 250 veículos e 4.500 funcionários.</p>
                            <p class="article">Empresas de diversos setores, como alimentação, varejo, bancário e gráfico estão entre alguns de seus principais clientes. Um dos diferenciais da empresa é o acompanhamento de perto pela diretoria de todas as atividades. Além disso, a equipe de campo é acompanhada constantemente através do rastreamento via satélite e pelo monitoramento via câmeras.</p>
                            <p class="article">Com essa nova filiação, a ANSEGTV conta atualmente com 16 membros. A entidade, assim, reforça seu objetivo em contribuir com os interesses da segurança privada por meio de ações que visem defender e fortalecer o livre mercado, a gestão empresarial ética e as boas práticas de segurança.</p>
                            <br>
                            <br>
                        </div>
