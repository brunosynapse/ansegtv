        ...
        <div class="row">
            <div class="col-12 col-md-8 destaque-1">
                <a href="">
                    <div class="overlay-image">
                        <img src="./img/uploads/2020/03/presidente-ansegtv.jpg" alt="" class="img-fluid destaque-1">
                    </div>
                    <div class="info-news">
            ...
            <div class="col-12 col-md-4">
                <div class="col-12 destaque-2">
                    <a href="">
                        <div class="overlay-image">
                            <img src="./img/uploads/2020/06/live_ansegtv_jun2020.jpg" alt="" class="img-fluid destaque-2">
                        </div>
                        <div class="info-news">
                ...
                <div class="col-12 destaque-3">
                    <a href="">
                        <div class="overlay-image">
                            <img src="./img/uploads/2020/05/ministerio-economia.png" alt="" class="img-fluid destaque-3">
                        </div>
                        <div class="info-news">
                            <span>29|01|2021</span>
                    ...
                    <div class="col-12 col-md-8 news-image-list">
                        <div class="row">
                            <div class="col-sm card">
                                <a href="">
                                    <div class="overlay-image">
                                        <img src="./img/uploads/2020/08/receita_federal_totem_12-08.png" alt="Receita Federal" class="img-fluid img-recentes">
                                        <span class="data">28|01|2021</span>
                                    </div>
                                    <h4 class="title-recentes">Lorem ipsum dolor strict text, sander agile sofos opus lorem</h4>
                                </a>
                            </div>
                            <div class="col-sm card">
                                <a href="">
                    ...
                    <div class="col-12 col-md-4 news-list">
                        <div class="col">
                            <a href="">
                                ...
                                <p class="desc">O assessor tributário da ANSEGTV (Associação Nacional de Segurança e Transporte de Valores), Andrey Ferreira, e Rubens Tavares, sócio da BMS Projetos & Consultoria, debateram em webinar nesta terça-feira (28) questões previdenciárias em tempos de pandemia.</p>
                            </a>
                        </div>
                        <div class="col">
                            <a href="">
