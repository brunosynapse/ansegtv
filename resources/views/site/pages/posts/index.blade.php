                    ...
                    @forelse($filteredPosts as $filteredPost)
                        ...
                        <div class="row py-4 news-finded">
                            <div class="col-12 col-md-5">
                                <a href="{{ route('site.show', $filteredPost->path) }}"><img src="{{ $filteredPost->image ? asset("storage/".$filteredPost->image) : asset('images/default-ansegtv.jpg') }}" alt="Imagem principal da notícia {{ $filteredPost->title }}" class="img-fluid"></a>
                            </div>
