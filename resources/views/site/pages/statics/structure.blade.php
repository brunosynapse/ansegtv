        ...
        <div class="container">
            ...
            <div class="row estrutura mb-4">
                ...
                <div class="col-md-5 my-3">
                    <img src="{{asset('images/icon-building.png')}}" alt="12 Empresas">
                    <p>FORMADA POR <strong>16 EMPRESAS</strong> DE SEGURANÇA E TRANSPORTE DE VALORES </p>
                </div>
                <div class="col-md-4 my-3 estados">
                    <img src="{{asset('images/icon_map.png')}}" alt="Presente em 24 Estados Brasileiros + DF">
                    <p><strong>25 ESTADOS</strong><br> BRASILEIROS + DF</p>
                </div>
                <div class="col-md-3 my-3 bases-operacionais">
                    <img src="{{asset('images/icon-factory.png')}}" alt="71 Bases operacionais">
                    <p><strong>81 BASES</strong><br> OPERACIONAIS</p>
                </div>
            </div>
            <div class="row servicos text-center">
                ...
                <div class="col-12">
                    <ul class="servicos">
                        ...
                        <li>
                            <img src="{{asset('images/icon-lock_2.png')}}" alt="">
                            <p>Custódia</p>
                        </li>
                        <li>
                            <img src="{{asset('images/icon-siren_2.png')}}" alt="">
                            <p>Escolta</p>
                        </li>

                        <li>
                            <img src="{{asset('images/icon-shield_2.png')}}" alt="">
                            <p>Vigilância</p>
                        </li>
                        <li>
                            <img src="{{asset('images/icon-transporte_2.png')}}" alt="">
                            <p>Transporte de Valores</p>
                        </li>
                        <li>
                            <img src="{{asset('images/icon-moneybag_2.png')}}" alt="">
                            <p>Gestão de <br>Numerário</p>
                        </li>
                        <li>
                            <img src="{{asset('images/icon-computer.png')}}" alt="">
                            <p>Segurança <br>Eletrônica</p>
                        </li>
                        <li style="height: 156px; vertical-align: top;">
                            <img src="{{asset('images/icon-others_2.png')}}" alt="">
                            <p></p>
                            <p>Outros</p>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="header-wrap">
                    <img src="{{asset('images/icon_map.png')}}" alt="Atuação da ANSEGTV" class="icon" width="92" height="92">
                    <h2 class="title">Atuação da ANSEGTV</h2><br>
                    <h3 class="subtitle">A ANSEGTV possui atuação nacional em 25 estados + DF. Clique no mapa para
                        conhecer as empresas.</h3>
                </div>
            </div>
        </div>
        <div class="container">
                        ...
                        <svg id="map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g class="model-orange">
                                ...
                                <a href="#" id="state_pe" class="state" data-state="pe" xlink:href="">
                                    ...
                                    <circle style="z-index:50" id="icon_se" class="icon_state" r="12" cx="452"
                                            cy="168"></circle>
                                ...
                                <a href="#" id="state_rs" class="state" data-state="rs" xlink:href="">
                                    ...
                                    <text id="label_state_rs" class="label_state" x="333" y="15">Rio Grande do Sul
                                    </text>
                                </a>
                                ...
                                <a href="#" id="state_ms" class="state" data-state="ms" xlink:href="">
                                    ...
                                    <text id="label_state_ms" class="label_state" x="322" y="15">Mato Grosso do Sul
                                    </text>
                                </a>
                                ...
                                <a href="#" id="state_rn" class="state" data-state="rn" xlink:href="">
                                    ...
                                    <text id="label_state_rn" class="label_state" x="317" y="15">Rio Grande do Norte
                                    </text>
                                </a>
