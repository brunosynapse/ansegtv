                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Reunião com secretário da Receita discute questões tributárias</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i>  AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>18/06/2020 - 16h15</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 content-news">
                            <p class="article">A ANSEGTV (Associação Nacional de Segurança e Transporte de Valores) e demais representantes do setor de serviços seguem em contato direto com o governo federal, trocando sugestões e propostas que têm como objetivo o reaquecimento da atividade econômica e a criação de empregos.</p>
                            <p class="article">Nesta quarta-feira (17), a reunião virtual foi com o secretário especial da Receita Federal, José Barroso Tostes Neto. A reunião foi organizada pela Frente Parlamentar em Defesa do Setor de Serviços, que é liderada pelo deputado federal Laércio Oliveira (PP-SE), e contou com a participação de Gabriel Damasceno, presidente da ANSEGTV.</p>
                            <p class="article">Na videoconferência, alguns temas discutidos foram a desoneração dos tributos sobre a folha de pagamentos, a necessidade da Reforma Tributária, a prorrogação ou não de medidas relacionadas a diferimento de tributos e uma possível reformulação do Refis.</p>
                            <figure class="pull-right m-2 text-right">
                                <img src="../../img/uploads/2020/06/receita_federal_ansegtv_jun2020.jpg" width="480" height="auto" alt="Receita Federal" class=" img-fluid">	
                                <figcaption>Fonte: Agência Senado</figcaption>
                            </figure>
                            <p class="article">Dentro da Reforma Tributária, representantes do setor manifestaram preocupação com possível substituição do PIS-COFINS e outros impostos pelo IVA (Imposto sobre Valor Agregado), que aumentaria consideravelmente a carga tributária do setor.</p>

                            <p class="article">Na reunião, a Secretaria demonstrou apoio à discussão sobre a redução da carga tributária sobre a folha de pagamentos e considerou importante a retomada do debate em torno da Reforma Tributária.</p>
                            <p class="article">Damasceno avaliou positivamente o encontro. “O governo está aberto a propostas e demonstra preocupação com o setor de serviços, que gera tantos empregos. Esse diálogo é fundamental”.</p>
                            <br>
                            <br>
                        </div>
