                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 title-news text-center">
                            <h1>Meios de pagamento se complementam</h1>
                            <p class="post-infos">
                                <span class="mx-2 author"><i class="fa fa-user"></i>AnsegTV</span> | <span class="mx-2 date"><i class="fa fa-clock-o"></i>23/11/2020 - 14h10</span> | <span class="mx-2 category"><i class="fa fa-tag"></i> ANSEGTV</span>
                            </p>
                            <hr class="divider">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 content-news">
                            <p class="article">Inovações tecnológicas surgem a cada dia, a cada momento. Aquele que não se reinventar ou se adaptar, certamente, ficará para trás.</p>
                            <p class="article">Nos meios de pagamento, não é diferente.</p>
                            <p class="article">Atualmente, muito se discute sobre o tema. No dia 16 de novembro, entrou em operação o Pix, sistema criado pelo Banco Central que possibilita o pagamento, a transferência e o recebimento de valores em instantes.</p>
                            
                            <p class="article">A cada novidade na área financeira, muitos especialistas já se adiantam em decretar o fim do dinheiro físico. A ANSEGTV acompanha com atenção as mudanças no setor e entende que é cedo para qualquer prognóstico.</em></p>
                            <p class="article">As diferentes formas de pagamento e transferências de valores, como papel moeda, cheque, cartões de débito, crédito, DOC, TED, sempre coexistiram harmoniosamente. Uma modalidade serve de auxílio à outra, sem que uma represente necessariamente o risco de extinção da outra.</p>
                            <figure class="pull-right m-2 text-right">
                                <img src="../../img/uploads/2020/11/dinheiro_ansegtv.jpg" width="450" height="auto" alt="Max Tavares" class=" img-fluid">	
                                <figcaption></figcaption>
                            </figure>
                            <p class="article">Vale lembrar que em 2020, diante da pandemia, a circulação de dinheiro cresceu. Essa tendência é explicada pelo pagamento do auxílio emergencial, o entesouramento, entre outras causas. Apesar do número maior de brasileiros com conta bancária, os trabalhadores informais, sem acesso a crédito e serviços financeiros, ainda representam uma grande parcela da população.</p>
                            <p class="article">Graças aos esforços de transportadoras de valores, não houve desabastecimento no ápice da crise, evitando um cenário econômico ainda pior. Empresas e indústrias começam a dar sinais de recuperação, mas as incertezas ainda são muitas.</p>
                            <p class="article">As associadas da ANSEGTV seguem trabalhando, em constante aprimoramento e atualização, prezando pela excelência no exercício das atividades. A entidade entende que os meios de pagamento eletrônico e físico são importantes, podendo atuar de formas complementares.</p>
                            <br>
                            <br>
                        </div>
