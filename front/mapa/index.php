  ...
  <div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="content-wrap">
                <div class="content">
                    <p>A Associação Nacional de Segurança e Transporte de Valores (ANSEGTV) é uma entidade brasileira de direito privado sem fins lucrativos criada em fevereiro de 2019.</p>
                    <p>Estruturada para representar os interesses das empresas que prestam serviços de segurança e transporte de valores, gestão de ciclo numerário, custódia de valores, logística de valores, vigilância e segurança patrimonial, segurança pessoal privada, escolta armada, tecnologia e segurança eletrônica e áreas complementares e afins, atuantes no Brasil, com o acompanhamento jurídico e legislativo.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="content-wrap">
                <div class="content">
                    <ul class="timeline">
                        <li>
                            <h3>Missão</h3>
                            <p>Contribuir com os interesses da segurança privada por meio de ações que visem defender e fortalecer o livre mercado, a gestão empresarial ética e as boas práticas de segurança.</p>
                        </li>
                        <li>
                            <h3>Visão</h3>
                            <p>Ser referência institucional no segmento da segurança privada, perante a sociedade e aos órgãos públicos, como entidade que atua em prol da livre concorrência no setor, da ampliação da oferta e da garantia de serviços seguros e de boa qualidade em todo o território brasileiro.</p>
                        </li>
                        <li>
                            <h3>Valores</h3>
    ...
    <div class="container">
        ...
        <section id="atuacao">
            ...
            <div class="container">
                <div class="row">
                    <div class="col map-wrap text-center">
                     <div class="box-mapa">
                        <svg id="map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="465" height="465">
                            <g class="model-orange">
                                ...
                                <a href="#" id="state_ba" class="state" data-state="ba" xlink:href="">
                                    ...
                                    <circle id="icon_ba" class="icon_state" r="12" cx="371" cy="212"></circle>
                                ...
                                <a href="#" id="state_al" class="state" data-state="al" xlink:href="">
                                    ...
                                    <circle id="icon_al" class="icon_state" r="12" cx="445" cy="190"></circle>
                                    <text id="label_icon_state_al" class="label_icon_state" x="439" y="194">AL</text>
                                ...
                                <a href="#" id="state_pe" class="state" data-state="pe" xlink:href="">
                                    ...
                                    <circle style="z-index:50" id="icon_se" class="icon_state" r="12" cx="452" cy="168"></circle>
                                    <text id="label_icon_state_pe" class="label_icon_state" x="446" y="172">PE</text>
                                ...
                                <a href="#" id="state_am" class="state" data-state="am" xlink:href="">
                                    ...
                                    <circle id="icon_am" class="icon_state" r="12" cx="103" cy="111"></circle>
                                    <text id="label_icon_state_am" class="label_icon_state" x="95" y="114">AM</text>
                                ...
                                <a href="#" id="state_pa" class="state" data-state="pa" xlink:href="">
                                    ...
                                    <circle id="icon_am" class="icon_state" r="12" cx="248" cy="108"></circle>
                                ...
                                <a href="#" id="state_ro" class="state" data-state="ro" xlink:href="">
                                    ...
                                    <circle id="icon_ro" class="icon_state" r="12" cx="128" cy="194"></circle>
                                ...
                                <a href="#" id="state_ac" class="state" data-state="ac" xlink:href="">
                                    ...
                                    <circle id="icon_ac" class="icon_state" r="12" cx="56" cy="183"></circle>
                                ...
                                <a href="#" id="state_ap" class="state" data-state="ap" xlink:href="">
                                    ...
                                    <circle id="icon_ap" class="icon_state" r="12" cx="255" cy="43"></circle>
                                ...
                                <a href="#" id="state_rs" class="state" data-state="rs" xlink:href="">
                                    ...
                                    <circle id="icon_rs" class="icon_state" r="12" cx="240" cy="415"></circle>
                                ...
                                <a href="#" id="state_sc" class="state" data-state="sc" xlink:href="">
                                    ...
                                    <circle id="icon_sc" class="icon_state" r="12" cx="273" cy="388"></circle>
                                ...
                                <a href="#" id="state_pr" class="state" data-state="pr" xlink:href="">
                                    ...
                                    <circle id="icon_ac" class="icon_state" r="12" cx="256" cy="354"></circle>
                                ...
                                <a href="#" id="state_sp" class="state" data-state="sp" xlink:href="">
                                    ...
                                    <circle id="icon_sp" class="icon_state" r="12" cx="291" cy="329"></circle>
                                ...
                                <a href="#" id="state_ms" class="state" data-state="ms" xlink:href="">
                                    ...
                                    <circle id="icon_ms" class="icon_state" r="12" cx="225" cy="301"></circle>
                                ...
                                <a href="#" id="state_go" class="state" data-state="go" xlink:href="">
                                    ...
                                    <circle id="icon_go" class="icon_state" r="12" cx="275" cy="264"></circle>
                                ...
                                <a href="#" id="state_mg" class="state" data-state="mg" xlink:href="">
                                    ...
                                    <circle id="icon_mg" class="icon_state" r="12" cx="339" cy="283"></circle>
                                ...
                                <a href="#" id="state_pi" class="state" data-state="pi" xlink:href="">
                                    ...
                                    <circle id="icon_pi" class="icon_state" r="12" cx="363" cy="156"></circle>
                                ...
                                <a href="#" id="state_ce" class="state" data-state="ce" xlink:href="">
                                    ...
                                    <circle id="icon_mg" class="icon_state" r="12" cx="402" cy="122"></circle>
                                ...
                                <a href="#" id="state_rr" class="state" data-state="rr" xlink:href="">
                                    ...
                                    <circle id="icon_rr" class="icon_state" r="12" cx="144" cy="38"></circle>
                                ...
                                <a href="#" id="state_to" class="state" data-state="to" xlink:href="">
                                    ...
                                    <circle id="icon_to" class="icon_state" r="12" cx="296" cy="185"></circle>
                                ...
                                <a href="#" id="state_ma" class="state" data-state="ma" xlink:href="">
                                    ...
                                    <circle id="icon_ma" class="icon_state" r="12" cx="332" cy="118"></circle>
                    ...
                    <div class="empresas">
                        <!-- select name="select" id="seletory">
                            <option value="ee" data-stado="ee">  </option> 
                        ...
                        <div id="box_mg" data-info="mg" style="opacity: 0" class="estado">
                            <h3>Minas Gerais</h3>
                                ...
                                <strong>Fidelys</strong><br>
                                <a href="http://grupofortebanco.com.br">http://grupofortebanco.com.br</a>
                        </div>
                        ...
                        <div id="box_ba" data-info="ba" class="estado">
                            ...
                            <a href="https://etmoq.com.br/">https://etmoq.com.br/</a>
                            <br>
                            <strong>Renaforte</strong><br>
                        ...
                        <div id="box_mt" data-info="mt" class="estado"></div>
                        ...
                        <div id="box_pa" data-info="pa" class="estado">
                            <h3>Pará</h3>
                                ...
                                <a href="https://sagavigilancia.com.br/">https://sagavigilancia.com.br</a>
                        </div>
                        ...
                        <div id="box_rr" data-info="rr" class="estado">
                            ...
                            <strong>Union Security</strong><br>
                            <a href="http://www.unionsecurity.com.br/">http://www.unionsecurity.com.br</a>
                        </div>
                        <div id="box_sc" data-info="sc" class="estado">
                            <h3>Santa Catarina</h3>
                            
                            <strong>Valorsat</strong><br>
                            <a href="http://www.inviosat.com.br">http://www.inviosat.com.br</a>
                        </div>
  ...
  <section id="footer" class="container">
            <div class="row">
                <div class="col-12 col-md-6 mb-3 contato-institucional">
                    ...
                    <p><strong>E-mail:</strong> diretoria@ansegtv.com.br</p>                 
                    <p><strong>Telefone:</strong> +55 61 3224-1006</p>   
                </div>
                <div class="col-12 col-md-6 contato-imprensa">
                    <p><strong>Assessoria de imprensa - </strong> Original 123</p>
                    <p><strong>E-mail: </strong>rafael.kimati@original123.com.br</p>
